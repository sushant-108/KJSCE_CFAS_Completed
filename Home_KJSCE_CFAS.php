...
<html>
    ...
    <body>   
        ...
        <div class = "page-container container bg-img" style = "padding-bottom:0px"> <!--middle part of page-->
            ...
            <p class = "page-content">
            If you are a student, then you will be required to submit the Course Feedback Forms 
            according to the Semester you are currently studying in. After submission, you will 
            be given a display of the options chosen by you in the form of a pie chart
            of that particular course. </p>
            <p class = "page-content">
            If you are a faculty member, then you will be given the authority to view all responses 
            to forms according to the subjects that you teach. The responses will be shown to you as
            a pie-chart. </p>
            <p class = "page-content">
            ...
            <div class = "footer-options">
                <div class = "footer-specific-option">
                    <button class = "btn btn-primary">
                        <img src = "img/home_icon.svg" class = "footer-links">&nbsp;&nbsp;&nbsp;&nbsp;<a href = "Home_KJSCE_CFAS.php" target = "_blank"><span style = "color:black">Home</span></a>
                    </button>
                </div>
            </div>
